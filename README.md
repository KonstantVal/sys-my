Дипломная работа по профессии «Системный администратор» - Шмаков Владимир
=========================================================================
Содержание 
==========
* [Задача](#Задача)
...
### Итог
После выполнения всех вышеуказанных шагов - Terraform готов к использованию для развёртывания ресурсов в Yandex Cloud. Также настроены необходимые конфигурационные файлы. Необходимо приступать к написанию Terraform-кода для создания облачных ресурсов.

### Развёртка Terraform
После подготовки остальных .tf конфигов можно начинать развертку из папки Terraform.

запуск развертки - terraform apply
